...
namespace Team14_Final_Project.Controllers
{
    public class InterviewTimesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="InterviewTimesID,StartTime")] InterviewTimes interviewtimes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="InterviewTimesID,StartTime")] InterviewTimes interviewtimes)
        {
            if (ModelState.IsValid)
            {
